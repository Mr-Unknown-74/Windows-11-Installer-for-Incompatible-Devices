...
:install
cd "%~dp0" 
powershell -NoProfile -ExecutionPolicy Bypass -Command "Start-Process -Verb RunAs powershell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File \"%~dp0\Code\extract.ps1\" -_vLUF '" 
exit
:remove
del /f /q "%Public%\get11.cmd" "%ProgramData%\get11.cmd" >nul 2>nul
reg delete "%IFEO%\SetupHost.exe" /f >nul 2>nul
RMDIR /Q /S "%~dp0\Code\ISO"
md "%~dp0\Code\ISO"
goto AftUninstall
